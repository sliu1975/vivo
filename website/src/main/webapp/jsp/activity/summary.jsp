                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="card-heading">
                                        <h4 class="card-title inline-block pdd-top-5">活动分析</h4>
                                                    ...
                                                    <c:if test="${not empty data.results }">
                                                        <c:forEach items="${data.results}" var="activity">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="mrg-top-10">
                                                                        <span>手机端地址:${pageContext.request.contextPath}/app/${activity.id } <a href="#" class="btn btn-info btn-xs">复制</a></span>
                                                                    </div>
                                                                </td>
                                                                <td>
