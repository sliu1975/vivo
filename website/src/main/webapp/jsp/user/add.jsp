                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <input type="text" name="name" class="form-control" required id="name" placeholder="用户ID">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="displayname" class="col-md-2 control-label">姓名</label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="displayname" class="form-control" required id="displayname" placeholder="姓名">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="department" class="col-md-2 control-label">部门</label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="department" class="form-control" id="department" placeholder="部门">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
