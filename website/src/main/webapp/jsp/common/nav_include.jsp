                    ...
                    <div class="search-wrapper">
                        <div class="pdd-vertical-10">
                            ...
                            <ul class="list-unstyled list-info">
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="${pageContext.request.contextPath}/assets/images/avatars/thumb-1.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="${pageContext.request.contextPath}/assets/images/avatars/thumb-5.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="${pageContext.request.contextPath}/assets/images/avatars/thumb-4.jpg" alt="">
                                        <div class="info">
                        ...
                        <div class="pdd-vertical-10">
                            ...
                            <ul class="list-unstyled list-info">
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="${pageContext.request.contextPath}/assets/images/img-1.jpg" alt="">
                                        <div class="info">
                                ...
                                <li>
                                    <a href="">
                                        <img class="thumb-img" src="${pageContext.request.contextPath}/assets/images/img-2.jpg" alt="">
                                        <div class="info">
        ...
        <ul class="nav-right">
            <li class="user-profile dropdown">
                <a href="" class="dropdown-toggle" data-toggle="dropdown">
                    <img class="profile-img img-fluid" src="${pageContext.request.contextPath}/assets/images/user.jpg" alt="">
                    <div class="user-info">
                        <span class="name pdd-right-5">${displayname }</span>
