...
/***/ function(module, exports, __webpack_require__) {
	...
	Zepto(function() {
	    ...
	    $('#btnConfirm').on('touchstart', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {},
                url: "${pageContext.request.contextPath}/app/share/${activity.id}",
	...
	function generatePoster() {
		...
		//canvas.width = $frameImg.data('width'); 
		//canvas.height = $frameImg.data('height'); 
