...
(function (factory) {
    ...
    previewCache = {
        ...
        get: function (id, i, isDisabled) {
            ...
            //TODO
            if(content.indexOf("file-preview-frame")>0)
            	out = content;
            else{
            ...
            self.$preview.find('.kv-file-remove').each(function () {
                ...
                handler($el, 'click', function () {
                    ...
                    $frame.fadeOut('slow', function () {
                        ...
                        if (len === 0 && hasThumb === 0) {
                            self.reset();
                            if(hideFileInput != undefined)
                            	hideFileInput(self.id);
                        } else {
                            n = chk + len;
...
//                self.$preview.html('');
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '',
        //browseClass: 'btn btn-primary btn-darkblue',
        browseClass: 'btn btn-lightblue',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileExtension: '只支持 "{extensions}" 的文件扩展名.',
